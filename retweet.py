...
# Where q='#pixelart', change #example to whatever hashtag or keyword you want to search.
...
for tweet in tweepy.Cursor(api.search, q='%23vaporwave%20OR%20%23pixelart').items(5):
    try:
